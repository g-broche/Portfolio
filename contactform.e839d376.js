...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/ts/contactform.ts":[function(require,module,exports) {
"use strict";
...
var modalFormContainer = document.getElementById("modal-form-wrapper");
var submitErrorMsg = document.getElementById("submit-error");
var contactEmail = document.getElementById("email-field");
var contactMessage = document.getElementById("message-field");
var contactLengthFeedback = document.getElementById("message-length");
var contactCancel = document.getElementById("form-cancel");
var contactSubmit = document.getElementById("form-submit");
var modalContactOverlay = document.getElementById("modal-contact-overlay");
/* ********** LOGIC CONST AND VARIABLES ********** */
var isEmailValid = false;
var isMessageValid = false;
var messageLengthRange = {
  min: 10,
  max: 1000
};
var regPattern = {
...
var formAction = "https://formspree.io/f/mrgwzovb";
/* ********** EVENT LISTENERS ********** */
...
function displayCurrentLength() {
  var currentlength = contactMessage.value.length;
  var message = "";
  if (currentlength < messageLengthRange.min) {
    ...
    if (contactLengthFeedback.classList.contains("error")) {
      contactLengthFeedback.classList.remove("error");
    }
  } else {
    message = currentlength + "/" + messageLengthRange.max;
    contactLengthFeedback.classList.add("error");
...
function openContactModal() {
  ...
  modalFormContainer === null || modalFormContainer === void 0 ? void 0 : modalFormContainer.classList.remove("hidden");
  modalContactOverlay === null || modalContactOverlay === void 0 ? void 0 : modalContactOverlay.classList.remove("hidden");
}
function closeContactModal() {
  modalFormContainer === null || modalFormContainer === void 0 ? void 0 : modalFormContainer.classList.add("hidden");
  modalContactOverlay === null || modalContactOverlay === void 0 ? void 0 : modalContactOverlay.classList.add("hidden");
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/ts/contactform.ts"], null)
//# sourceMappingURL=/contactform.e839d376.js.map